/*Os seus produtos  (coquinha, sorvete seco, paçoquinha) também tem um custo! Nada na vida é de graça. Adicione estes custos também ao contador de despesas, após cada venda.*/
let lista = []
let listaCQ = []
let listaMQ = []
let listaRefri = []
